...
const getAlbumSongsApi = async (albummid: any) => {
    return httpFetch(`https://i.y.qq.com/v8/fcg-bin/fcg_v8_album_info_cp.fcg?platform=h5page&albummid=${albummid}&g_tk=938407465&uin=0&format=json&inCharset=utf-8&outCharset=utf-8&notice=0&platform=h5&needNewCode=1&_=1459961045571`).promise.then(({ body }: any) => {
...
export default {
     ...
     * @param {string} order
     */
    getArtistSongs(id: any, page: any= 1, limit: any= 100, order: any= 'hot') {
     ...
     * @param {string} order
     */
    getArtistAlbums(id: any, page: any= 1, limit: any= 50, order: any= 'hot') {
        return singer.getAlbumList(id, page, limit, order).then((data: any) => {
     ...
     */
    getAlbumSongs(id: any) {
        return getAlbumSongsApi(id).then((data: any) => {
