...
export default {
  ...
  ] as Array<{ id: string; name: string; bangid: string | number }>,
  listDetailRequest(id: any, period: any, limit: any) {
  ...
  async getBoards(retryNum: any= 0) {
